      ...
      <div class="row">
        ...
        <div class="column2">
            <?php 
                include("conn.php");
                $counter = 0;
                $sql = "SELECT * FROM coffee_bean";
                $result=mysqli_query($con,$sql); //con is database, sql query (select, delete)
                $num_row = mysqli_num_rows($result); // found how many record above
                $array = mysqli_fetch_array($result);
                $image = mysqli_fetch_assoc($result); // take image (blob)
                $dynamic = "<div class = 'product-container' onclick=\"popup('" .$counter ."')\">";
            ...
            <div class="content">
              ...
              orci quam, gravida a lacus eu, ultricies iaculis ex. Nunc eu nisl
              sit amet justo eleifend rutrum.
            </div>
          ...
          <div class="product-container" onclick="popup('4','../img/KenyaAA.jpg')">
            <img
              id="imgPopup"
              src="../img/KenyaAA.jpg"
              width="350"
