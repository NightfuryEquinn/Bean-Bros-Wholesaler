                ...
                <div class="admin-profile-parallax-base">
                    ...
                    <div class="admin-profile-container">
                        ...
                        <div class="admin-function-container">
                            <div class="afc-top">
                                <h5><a href="checkfeedback.html">View Feedback</a></h5>
                                <h5><a href="checkcustomer.html">Manage Customer</a></h5>
                                <h5><a href="checkorder.html">Manage Order</a></h5>
                            </div>
                            <div class="afc-bottom">
                                <h5><a href="monthlyreport.html">Generate Monthly Report</a></h5>
                                <h5><a href="addproduct.html">Add New Coffee Bean</a></h5>
                            </div>
                        </div>
                    </div>
                    <!--Footer-->
